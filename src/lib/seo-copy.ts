...
export const metaDescriptions = {
  ...
  jakProbiha: `Jak probíhá ${site.name}: ${site.pricing.lessonMinutes} minut jednou za 14 dní, celkem ${site.pricing.lessons} lekcí. Přehled průběhu, technických požadavků i role rodiče.`,
